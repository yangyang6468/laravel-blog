...
@section("content")
    <link href="{{ asset('css/editUser.css') }}?20180813" rel="stylesheet">
    ...
    <div class="row" style="margin: 20px;">
        ...
        {{--选择默认图像模板start--}}
        <div id="showImage" >
            <input type="hidden" id="defaultIcon">
            ...
            layui.use(['layer'],function () {
                ...
                layer.open({
                    ...
                    yes:function(index, layero){
                        var icon = $("#defaultIcon").val();
                        if(!icon){
                            layer.msg("请选择图像");
                            return false;
                        }
                        $("#headimage").val(icon);
                        $("#upload").attr("src" , "{{ config('app.manager') }}"+icon);
                        $("#flag").val(2);
                        layer.close(index)
                    }
                });
    ...
    <script>
        ...
        function chooseIcon(obj){
            ...
            $("#defaultIcon").val($(obj).children(".icon").val())
        }
